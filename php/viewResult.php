...
//trial for checking the roll number

$result = mysqli_query($al, "SELECT * FROM students WHERE roll='$_POST[roll]'");
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        $roll1 = $row['roll'];
    }
    if ($_POST['roll'] != $roll1) {
            echo 'Please enter Correct Roll No!';
        die(include 'index2.php');
    } else {
        $roll = $_POST['roll'];
    ...
    <body><br />
        ...
        <div align="center">
            ...
            <span class="labels" style="color:#C9F;">Name : <?php echo $name; ?><br>Roll No.: <?php echo $roll; ?><br>Semester : <?php echo $sem; ?></span>
                        ...
                        <br />
                        <?php
                        $m = mysqli_query($al, "SELECT * FROM subjects WHERE sem='$sem'");
