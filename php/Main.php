    ...
    <body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="index.php">Faculty Corner</a></li>
                ...
                <a class="btn-getstarted" href="index.php">Login</a>
        ...
        <main id="main">
            ...
            <section id="stats" class="stats">
                ...
                <img src="assets/img/logo.png"  alt="" data-aos="fade-in">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="stats-item text-center w-100 h-100">
                                <span data-purecounter-start="0" data-purecounter-end="756421" data-purecounter-duration="1" class="purecounter"></span>
                                <p>Students</p>
                            </div>
                        </div><!-- End Stats Item -->
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="stats-item text-center w-100 h-100">
                                <span data-purecounter-start="0" data-purecounter-end="602" data-purecounter-duration="1" class="purecounter"></span>
                                <p>Staff</p>
                            </div>
                        </div><!-- End Stats Item -->
